...
/************* Muestra los errores de PY *************/
function ShowErrorsPY(){
    alert("Actualizado 22");
    let SendErrorsPY = "";
    if(errorsArrayPY!=null){
        errorsArrayPY.forEach(error => {
            SendErrorsPY += error + "\n";
        });
        document.getElementById("txtpython").value = SendErrorsPY;

    }else{
        document.getElementById("txtpython").value = "";

    }
}

/************* Muestra los tokens de PY *************/
function ShowTokensPY() {
    alert("Actualizado 22");

    var url = 'http://localhost:8079/tokensPY/';
    ...
    let SendTokensPY = "";
    let contadorPY = 1;
    tokensArrayPY.forEach(token => {
        SendTokensPY += contadorPY + ". "+token + "\n";
        contadorPY+=1;
    });
    document.getElementById("txtTokens").value = SendTokensPY;


}


/************* Muestra codigo del arbol PY *************/
function ShowTreePY(){
    alert("Actualizado 22");
    var url = 'http://localhost:8079/arbolPY/';
...
function ASTPY(){
    ...
    */
    let htmlText = '<!DOCTYPE html>'
        ...
        + '</body>\n' 
        +'</html>\n' 
    saveFile(htmlText, "ASTPython.html");
